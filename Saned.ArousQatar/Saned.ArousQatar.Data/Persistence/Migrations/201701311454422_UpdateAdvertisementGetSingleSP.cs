namespace Saned.ArousQatar.Data.Persistence.Migrations
{
    ...
    public partial class UpdateAdvertisementGetSingleSP : DbMigration
    {
            ...
            AlterStoredProcedure(
                ...
                @"
		            ...
		            Advertisments.Name,
						...
						[CreateDate],[IsPaided],[PaidEdPrice],[CategoryId],[AdvertismentPriceId],Advertisments.[IsArchieved],[StartDate],[EndDate],
        ...
        {
            DropStoredProcedure("[dbo].[AdvertisementGetSingle]");
        }
    }
}
