...
angular
    ...
    .factory('authService', ['$http', '$q', 'localStorageService', 'appSettings', function ($http, $q, localStorageService, appSettings) {
    ...
    .factory('tokensManagerService', ['$http', 'appSettings', function ($http, appSettings) {
